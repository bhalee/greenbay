...
function LoggedOut() {
  return (
    <div className="main-text">
      <h1>WELCOME</h1>
      <h3>
        Please registring on greenbay and give us your money!<br></br>
      ...
      <img alt="market" src="https://media.kasperskydaily.com/wp-content/uploads/sites/92/2014/10/06042257/Why-it-can-be-unsafe-to-buy-Kaspersky-products-from-eBayAmazon-merchants.png"></img>
    </div>
  );
}
